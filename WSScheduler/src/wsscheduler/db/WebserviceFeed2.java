...
@Entity
@NamedQueries({ @NamedQuery(name = "WebserviceFeed2.findAll", query = "select o from WebserviceFeed2 o") })
@Table(name = "WEBSERVICE_FEED2")
public class WebserviceFeed2 implements Serializable {
    private static final long serialVersionUID = -5305572455382251997L;
    ...
    public WebserviceFeed2() {
    }

    public WebserviceFeed2(Date createtime, String filecontent, String membercode, String operation,
